...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field profiles on 'Group'
        m2m_table_name = db.shorten_name(u'groups_group_profiles')
        ...
        db.create_unique(m2m_table_name, ['group_id', 'profile_id'])


    def backwards(self, orm):
        # Removing M2M table for field profiles on 'Group'
        db.delete_table(db.shorten_name(u'groups_group_profiles'))
