...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.is_discipline'
        db.add_column(u'groups_group', 'is_discipline',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.is_discipline'
        db.delete_column(u'groups_group', 'is_discipline')
