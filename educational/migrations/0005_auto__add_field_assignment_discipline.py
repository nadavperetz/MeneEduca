...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assignment.discipline'
        db.add_column(u'educational_assignment', 'discipline',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['educational.Discipline']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assignment.discipline'
        db.delete_column(u'educational_assignment', 'discipline_id')
    ...
    models = {
        ...
        u'educational.assignment': {
            ...
            'group': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['groups.Group']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
