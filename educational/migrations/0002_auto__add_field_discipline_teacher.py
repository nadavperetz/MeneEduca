...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discipline.teacher'
        db.add_column(u'educational_discipline', 'teacher',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['profiles.Teacher'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discipline.teacher'
        db.delete_column(u'educational_discipline', 'teacher_id')
    ...
    models = {
        ...
        u'educational.discipline': {
            ...
            'teacher': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profiles.Teacher']", 'blank': 'True'})
        },
        u'profiles.profile': {
