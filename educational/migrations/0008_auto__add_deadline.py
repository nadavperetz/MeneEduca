...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'educational_deadline', (
        ...
        db.send_create_signal(u'educational', ['Deadline'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'educational_deadline')
    ...
    models = {
        ...
        u'educational.assignment': {
            ...
            'deadlines': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['educational.Deadline']", 'null': 'True', 'blank': 'True'}),
