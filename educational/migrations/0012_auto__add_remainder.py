...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'educational_remainder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 9, 0, 0))),
            ...
            ('forum', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agora.Forum'])),
        ))
        db.send_create_signal(u'educational', ['Remainder'])


    def backwards(self, orm):
        # Deleting model 'Remainder'
        db.delete_table(u'educational_remainder')
