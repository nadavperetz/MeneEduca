...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field deadlines on 'Assignment'
        db.delete_table(db.shorten_name(u'educational_assignment_deadlines'))

        # Adding field 'Deadline.assignment'
        db.add_column(u'educational_deadline', 'assignment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['educational.Assignment']),
                      keep_default=False)

        # Adding M2M table for field event on 'Deadline'
        m2m_table_name = db.shorten_name(u'educational_deadline_event')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('deadline', models.ForeignKey(orm[u'educational.deadline'], null=False)),
            ('event', models.ForeignKey(orm[u'events_calendar.event'], null=False))
        ))
        db.create_unique(m2m_table_name, ['deadline_id', 'event_id'])


    def backwards(self, orm):
        # Adding M2M table for field deadlines on 'Assignment'
        m2m_table_name = db.shorten_name(u'educational_assignment_deadlines')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('assignment', models.ForeignKey(orm[u'educational.assignment'], null=False)),
            ('deadline', models.ForeignKey(orm[u'educational.deadline'], null=False))
        ))
        db.create_unique(m2m_table_name, ['assignment_id', 'deadline_id'])

        # Deleting field 'Deadline.assignment'
        db.delete_column(u'educational_deadline', 'assignment_id')

        # Removing M2M table for field event on 'Deadline'
        db.delete_table(db.shorten_name(u'educational_deadline_event'))
    ...
    models = {
        ...
        u'educational.assignment': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['groups.Group']", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'educational.deadline': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 22, 0, 0)'})
        },
        ...
        u'educational.grade': {
            ...
            'discipline': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['educational.Discipline']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'student_grade'", 'to': u"orm['profiles.Student']"}),
