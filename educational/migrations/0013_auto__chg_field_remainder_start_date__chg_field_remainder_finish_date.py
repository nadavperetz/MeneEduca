...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Remainder.start_date'
        db.alter_column(u'educational_remainder', 'start_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Remainder.finish_date'
        db.alter_column(u'educational_remainder', 'finish_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Remainder.start_date'
        db.alter_column(u'educational_remainder', 'start_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Remainder.finish_date'
        db.alter_column(u'educational_remainder', 'finish_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'educational.deadline': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 9, 0, 0)'})
        },
        ...
        u'educational.remainder': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 12, 9, 0, 0)'})
        },
