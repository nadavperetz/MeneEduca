...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Discipline.group'
        db.alter_column(u'educational_discipline', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groups.Group'], null=True))

    def backwards(self, orm):

        # Changing field 'Discipline.group'
        db.alter_column(u'educational_discipline', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['groups.Group']))
