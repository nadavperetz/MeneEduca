...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QuestionIpip.answer_value'
        db.delete_column(u'survey_questionipip', 'answer_value')


    def backwards(self, orm):
        # Adding field 'QuestionIpip.answer_value'
        db.add_column(u'survey_questionipip', 'answer_value',
