...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnswersIpipCompleted.completed'
        db.add_column(u'survey_answersipipcompleted', 'completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnswersIpipCompleted.completed'
        db.delete_column(u'survey_answersipipcompleted', 'completed')
