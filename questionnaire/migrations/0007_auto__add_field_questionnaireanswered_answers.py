...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionnaireAnswered.answers'
        db.add_column(u'questionnaire_questionnaireanswered', 'answers',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionnaireAnswered.answers'
        db.delete_column(u'questionnaire_questionnaireanswered', 'answers')
    ...
    models = {
        ...
        u'questionnaire.questionnaireanswered': {
            ...
            'answers': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'questionnaire': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['questionnaire.QuestionnaireModel']"}),
