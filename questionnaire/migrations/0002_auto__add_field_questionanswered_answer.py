...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionAnswered.answer'
        db.add_column(u'questionnaire_questionanswered', 'answer',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionAnswered.answer'
        db.delete_column(u'questionnaire_questionanswered', 'answer')
