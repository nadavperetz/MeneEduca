...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionAnswered.questionnaire_answered'
        db.add_column(u'questionnaire_questionanswered', 'questionnaire_answered',
    ...
    def backwards(self, orm):
        # Deleting field 'QuestionAnswered.questionnaire_answered'
        db.delete_column(u'questionnaire_questionanswered', 'questionnaire_answered_id')
    ...
    models = {
        ...
        u'questionnaire.questionanswered': {
            ...
            'questionnaire_answered': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['questionnaire.QuestionnaireAnswered']"})
        },
