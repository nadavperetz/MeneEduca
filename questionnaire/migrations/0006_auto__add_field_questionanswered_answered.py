...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionAnswered.answered'
        db.add_column(u'questionnaire_questionanswered', 'answered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionAnswered.answered'
        db.delete_column(u'questionnaire_questionanswered', 'answered')
