...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Forum.groups'
        db.alter_column(u'agora_forum', 'groups_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groups.Group']))

    def backwards(self, orm):

        # Changing field 'Forum.groups'
        db.alter_column(u'agora_forum', 'groups_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Group']))
    ...
    models = {
        u'agora.forum': {
            ...
            'groups': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['groups.Group']"}),
