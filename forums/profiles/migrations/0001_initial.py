...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Groups'
        db.create_table(u'profiles_groups', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=75)),
        ))
        db.send_create_signal(u'profiles', ['Groups'])
        ...
        db.create_table(u'profiles_profile', (
            ...
            ('complete_profile', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.create_unique(m2m_table_name, ['profile_id', 'groups_id'])

        # Adding model 'Course'
        db.create_table(u'profiles_course', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course_name', self.gf('django.db.models.fields.CharField')(max_length=75)),
        ))
        db.send_create_signal(u'profiles', ['Course'])
        ...
        m2m_table_name = db.shorten_name(u'profiles_teacher_courses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('teacher', models.ForeignKey(orm[u'profiles.teacher'], null=False)),
            ('course', models.ForeignKey(orm[u'profiles.course'], null=False))
        ))
        db.create_unique(m2m_table_name, ['teacher_id', 'course_id'])

        # Adding model 'Student'
        db.create_table(u'profiles_student', (
            (u'profile_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['profiles.Profile'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'profiles', ['Student'])

        # Adding M2M table for field courses on 'Student'
        m2m_table_name = db.shorten_name(u'profiles_student_courses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('student', models.ForeignKey(orm[u'profiles.student'], null=False)),
            ('course', models.ForeignKey(orm[u'profiles.course'], null=False))
        ))
        db.create_unique(m2m_table_name, ['student_id', 'course_id'])

        # Adding model 'Guardian'
        db.create_table(u'profiles_guardian', (
            (u'profile_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['profiles.Profile'], unique=True, primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Student'])),
        ))
        db.send_create_signal(u'profiles', ['Guardian'])


    def backwards(self, orm):
        # Deleting model 'Groups'
        db.delete_table(u'profiles_groups')
        ...
        db.delete_table(u'profiles_course')

        # Deleting model 'Teacher'
        db.delete_table(u'profiles_teacher')

        # Removing M2M table for field courses on 'Teacher'
        db.delete_table(db.shorten_name(u'profiles_teacher_courses'))

        # Deleting model 'Student'
        db.delete_table(u'profiles_student')

        # Removing M2M table for field courses on 'Student'
        db.delete_table(db.shorten_name(u'profiles_student_courses'))

        # Deleting model 'Guardian'
        db.delete_table(u'profiles_guardian')
    ...
    models = {
        ...
        u'profiles.course': {
            ...
            'course_name': ('django.db.models.fields.CharField', [], {'max_length': '75'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'profiles.groups': {
        ...
        u'profiles.guardian': {
            'Meta': {'object_name': 'Guardian', '_ormbases': [u'profiles.Profile']},
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profiles.Student']"}),
        ...
        u'profiles.profile': {
            ...
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'default': "'General'", 'to': u"orm['profiles.Groups']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'profiles.student': {
            'Meta': {'object_name': 'Student', '_ormbases': [u'profiles.Profile']},
            'courses': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['profiles.Course']", 'null': 'True', 'blank': 'True'}),
            u'profile_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['profiles.Profile']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'profiles.teacher': {
            'Meta': {'object_name': 'Teacher', '_ormbases': [u'profiles.Profile']},
            'courses': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['profiles.Course']", 'null': 'True', 'blank': 'True'}),
            u'profile_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['profiles.Profile']", 'unique': 'True', 'primary_key': 'True'})
        }
    }
