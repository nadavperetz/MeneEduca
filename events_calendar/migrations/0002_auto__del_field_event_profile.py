...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'events_calendar_event', 'profile_id')

        # Adding M2M table for field profile on 'Event'
        m2m_table_name = db.shorten_name(u'events_calendar_event_profile')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'events_calendar_event', 'profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['profiles.Profile']),
                      keep_default=False)

        # Removing M2M table for field profile on 'Event'
        db.delete_table(db.shorten_name(u'events_calendar_event_profile'))
